...
function createDOM__greenEnergy(state) {
    if (state.toLowerCase() == 'yes') {
        return ' <img src="./iwov-resources/flp/images/emp/eco.svg" alt="" data-toggle="tooltip" data-placement="top" title="Eco-friendly"><span class="hidden ecofriendly">1</span>';
    } else { return '<span class="hidden ecofriendly">0</span>' }
}
